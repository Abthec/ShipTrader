...
public class RandomEvent {
     ...
     * Assigns randomEventRarity to a random randomEventRarity.
     * Assigns randomEventType to a random randomEventType.
     */
    public RandomEvent() {
    ...
    /**
     * Gets a random double between 0 and 1 and checks if it is smaller than the RandomEvent's RandomEventRarity.
     * 
