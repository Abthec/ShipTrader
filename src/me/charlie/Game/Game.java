...
/**
 * The top of the information hierarchy, all the data of the current game is
 * stored here.
 * 
 * @author charlie.
 */
public class Game {
	...
	/**
	 * Creates an instance of the game, this is where all the data about the game is
	 * stored.
	 * 
	 ...
	 * @param islandTotal  the amount of islands that will be generated. (5 is in
	 *                     specifications).
	 */
	...
	/**
	 * Sets the amount of days remaining in the game. Used to determine if there is
	 * enough days remaining to sail chosen routes/continue the game.
	 * 
	 * @param daysSailed the amount of days, as an int, taken to sail the chosen
	 *                   route.
	 */
	...
	/**
	 * Checks to see if it is possible to sail to another island. Used to check
	...
	/**
	 * Creates a list of Island objects. Also creates an instance of
	 * IslandNameHandler which is used to designate names to the islands.
	 * 
	...
	/**
	 * 
	 * @return a list of the Island objects used in the current instance of the
	 *         game.
	 */
	...
	/**
	 * 
	 * @return a list of all the Route objects generated for the current instance of
	 *         the game.
	 */
