...
public class ShipNameHandler {
    ...
    /**
     * Creates an instance of ShipNameHandle and adds all the possible names to a list.
     */
    ...
    /**
     * selects a random name from the list of names and then removes it from the list.
     * 
