...
public enum UpgradeType {
	CANNON, MAST, BULKHEAD, CARGO_HOLD;

	/**
	 * Gets the effect description of the UpgradeType depending on UpgradeType.
	 * 
	 * @param upgradeType the type of a given upgrade.
	 * @return the effect description of the UpgradeType
	 */
