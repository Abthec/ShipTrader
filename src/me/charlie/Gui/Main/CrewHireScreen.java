...
public class CrewHireScreen {
	...
	private void initialize() {
		...
		JLabel lblSpeedWarning = new JLabel("If your crew employed is less than half your total crew you will suffer a sailing speed penalty.");
		...
		lblCurrentCrew.setText("Current crew size: " + game.getShip().getCurrentCrewSize() + "/" + game.getShip().getMaxCrewSize());
