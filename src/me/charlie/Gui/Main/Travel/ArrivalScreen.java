...
/**
 * The screen displayed when the player arrives at a new Island.
 * 
 * @author charl
 *
 */
public class ArrivalScreen {
	...
	private void initialize() {
		...
		lblWelcome.setText(
				"  Welcome " + game.getTrader().getName() + " to " + currentIsland.getName() + ". Enjoy your stay!");
		...
		lblStoreDetails.setText(
				"On this island there is a " + store.getStoreType().getName() + " called " + store.getName() + ".");
