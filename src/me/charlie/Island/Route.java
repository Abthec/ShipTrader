...
/**
 * Stores infomation about routes between islands.
 * 
 * @author charlie
 *
 */
public class Route {
	...
	public Route(Island islandA, Island islandB) {
		...
		this.distance = islandA.getCoordinate().getDistance(islandB.getCoordinate())
				* randomEvent.getRandomEventRarity().getEventDistanceModifier();
	}
	...
	/**
	 * Calculates how many days should be deducted from the days remaining in the
	 * game.
	 * 
