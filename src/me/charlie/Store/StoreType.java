...
/**
 * Handles the different types of Stores and the effect that has on item cost.
 * 
 * @author charlie
 *
 */
public enum StoreType {
	...
	JEWELER, ARTIFICER, SHIP_BUILDER, BLACKSMITH;
	...
	/**
	 * get the selling coefficient of a given ItemType depending on the Store at
	 * which it is being sold.
	 * 
	 * @param itemType the type of an item in the players inventory within the Store
	 *                 sell window.
	...
	/**
	 * get the maximum amount of items a given StoreType can have within their
	 * stock.
	 * 
	...
	/**
	 * get the minimum amount of items a given StoreType can have within their
	 * stock.
	 * 
